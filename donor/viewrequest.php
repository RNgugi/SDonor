...
<div class="wrap">
	<ul class="nav">
          <img src="../Images/Capture.JPG"/ width="200px" height="60px">	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div style="height:300px; width:1000px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;">
 ...
 <tr style="background-color:bisque" align="center" class="bold">            
             <td class="bold" style="color:red"  >Blood Group</td><td align="center">Name</td><td align="center">Gender</td><td align="center">Email</td>
             <td align="center">Till Required Date</td><td align="center">Issued</td>
        </tr>
...
$s="select * from requestes";
	...
	{
				echo"<tr><td  style=' padding-left:50px'>$data[0]</td><td  style=' padding-left:10px'>$data[1]</td><td  style=' padding-left:20px'>$data[2]</td><td  style=' padding-left:50px'>$data[5]</td><td  style=' padding-left:60px'>$data[6]</td><td  style=' padding-left:60px'>$data[8]</td></tr>";
			}
			mysqli_close($cn);
			?>
