...
<tr><td class="lefttd">County </td><td><select name="s1" required><option value="">Select</option>
...
<tr><td class="lefttd">Town </td><td><select name="s2" required><option value="">Select</option>
