...
<div class="nav_bg">
<div class="wrap">
		<ul class="nav"> <img src="../Images/Capture.JPG" width="200px" height="60px" />
			<li class="active" style=" float:right;"><a href="../index.php" target="_blank">Preview Website</a></li>	
...
<div class="footer">
	<div class="f_nav">
		...
		<div class="copy">
			<p class="title">© All Rights Reserved | Designed by Miss Benson Maina|</p>
		</div>
	<div class="clear"></div>
</div>
</div>
