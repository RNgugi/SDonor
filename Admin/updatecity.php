...
<tr><td colspan="2" align="center" class="toptd">Update town </td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td class="lefttd">Select town </td><td><select name="s2"><option value="Select">Select</option>
...
?>
<tr><td class="lefttd">Town Name</td><td><input type="text" name="t3"  value="<?php  if(isset($_POST["show"])){ echo $city_name ;}    ?>" required="required" pattern="[a-zA-Z _]{5,18}" title="please enter only character  between 5 to 18 for town name"  /></td></tr> </td></tr></td></tr>
