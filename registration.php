...
<tr><td class="lefttd">ID No</td><td><input type="number" name="id" required="required"  title="please enter only 8 numbers for your ID no." /></td></tr>                        
...
<tr><td class="lefttd">Town</td><td><input type="text" name="t5" required="required" /></td></tr>
...
//aloow certain file formats
	if($imageFileType != "jpg" && $imageFileType !="png" && $imageFileType !="jpeg" && $imageFileType !="gif"){
		...
		$cn=makeconnection();
			$s="insert into donarregistration(name,gender,age,mobile, na_id, b_id,email,pwd,pic) values('" . $_POST["t1"] ."','" . $_POST["r1"] . "','" . $_POST["t2"] . "','" . $_POST["t3"] . "','" . $_POST["id"] . "','" . $_POST["t4"] . "','" . $_POST["t5"] . "','" . $_POST["t6"] .  "','" . basename($_FILES["t8"]["name"])  ."')";
